...
namespace ServvistaWebAppAPI.Controllers
{
    ...
    public class ServiceController : ControllerBase
    {
        ...
        //GET api/service/getmonthlyservicevisits?techCode={techCode}
        [Authorize]
        [HttpGet("getmonthlyservicevisits")]
        public async Task<IActionResult> GetMonthlyServiceVisit(string techCode)
        {
            try
            {
                var result = _serviceSchedule.GetMonthlyVisits(techCode);
                return Ok(result); 
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> GetMonthlyServiceVisitsCount(string techCode)
        {
            try
            {
                var serviceVisitsForMonth = _serviceSchedule.GetMonthlyVisitCount(techCode).Result; 
        ...
        [Authorize]
        [HttpGet("getmonthlyvisits")]
        public async Task<IActionResult> GetMonthlyVisitCount(string techCode)
        {
            try
            {
                var result = _serviceSchedule.GetMonthlyVisitCount(techCode).Result;
                return Ok(result);
            }
            catch (Exception ex)
            {
